    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('opportunity_field', models.CharField(choices=[('Design', 'Design'), ('Event', 'Event Organizer'), ('Teaching', 'Teaching'), ('Operations', 'Operations'), ('Marketing', 'Marketing'), ('Photography', 'Photography'), ('Engineering', 'Engineering'), ('Media', 'Media and Communication'), ('Finance', 'Finance'), ('Fashion', 'Fashion'), ('Web Dev', 'Web Development'), ('Other', 'Other')], max_length=140)),
